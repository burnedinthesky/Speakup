		...
		>
			<div className="ml-64 mb-10 flex justify-center scrollbar-hide ">
				<div className="w-full max-w-4xl px-4 pb-40">
					...
					<Tabs color="cyan" value={activeTab} onTabChange={setActiveTab}>
						<Tabs.List>
							<Tabs.Tab value="pass" icon={<CheckIcon className="w-4" />}>
								通過
							</Tabs.Tab>
							<Tabs.Tab value="failed" icon={<XIcon className="w-4" />}>
								不通過
							</Tabs.Tab>
						</Tabs.List>
