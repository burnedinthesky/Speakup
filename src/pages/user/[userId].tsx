			...
			<div className="mx-auto my-16 w-full max-w-4xl rounded-lg bg-neutral-50 py-10 px-4 sm:px-8 lg:my-24 lg:px-12">
				<div className="flex w-full flex-col items-center">
					...
					<p className="mt-3 text-neutral-700">
						<span className="inline-block">{userData.arguments}個論點</span>
						・
						<span className="inline-block">{userData.comments}則回覆</span>
						・
						<span className="inline-block">{userData.articles}篇議題</span>
					</p>
				</div>
