...
const UserLaunchedDebates = () => {
	const debates = useDebateStore((state) => state.userLaunched);
	...
	useEffect(() => {
		// addDebate([SampleDebate], "userLaunched");
	}, []);
...
export default UserLaunchedDebates;
