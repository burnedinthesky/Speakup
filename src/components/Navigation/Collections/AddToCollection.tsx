				...
				<div className="flex w-full justify-end">
					{isSelected ? (
						<button
							...
							onClick={() => {
								if (!data) throw new Error("Collection is null");
								deleteCollectionMutation.mutate({
									collectionId: data.id,
								});
							}}
						>
							<LoadingIconWrapper loading={deleteCollectionMutation.isLoading}>
						...
						>
							<LoadingIconWrapper loading={upsertCollectionMutation.isLoading}>
