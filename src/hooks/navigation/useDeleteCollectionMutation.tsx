	...
	const deleteCollectionMutation =
		trpc.navigation.deleteUserCollection.useMutation({
			...
			onMutate: () => {
				...
				const prevData = trpcUtils.navigation.getSingleCollection.getData();
				const prevSets = trpcUtils.navigation.getCollectionSets.getData();

				trpcUtils.navigation.getSingleCollection.setData({ articleId }, null);
